...
| Get customer info | `api/user/customer`          | `GET`    | yes       | [example](#user-customer---get-user-info) |
| Update customer   | `api/user/customer`          | `UPDATE` | yes       | [example](#user-customer---update-user)   |
...
| Get driver info            | `api/user/driver`            | `GET`    | yes       | [example](#user-driver---get-user-info) |
| Update driver              | `api/user/driver`            | `UPDATE` | yes       | [example](#user-driver---update-user)   |
